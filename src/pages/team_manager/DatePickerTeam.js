...
const DatePickerTeam = ({ props, onFilter, teamData, setRecords }) => {
  ...
  const FilterDataByDate = async (data) => {
    try {
      ...
      const response = await apiGet(pathObj.FILTER_DATA_BY_DATE_TEAMS, payload);
